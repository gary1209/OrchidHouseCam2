var ADDR_IP_CAM = "61.221.168.228";
var PORT_IP_CAM_API = "80";
...
var ADDR_REMOTE_CONTROL  = "http://iot.iottalk.tw:9999/SwitchSetV2/Orchid%20Light%20Control/16/?username=tsmc";
var ADDR_REMOTE_CONTROL2 = "http://iot.iottalk.tw:9999/SwitchSetV2/Light2/16/?username=tsmc";
...
window.addEventListener('load', function(){
	if(ENABLE_AUTH_IP_CAM == 1) {
		document.getElementById("address").value="rtsp://" + UNAME_IP_CAM + ":" + UWORD_IP_CAM + "@" + ADDR_IP_CAM + ":" + PORT_IP_CAM_RTSP + "/h264";
	} else {
		document.getElementById("address").value="rtsp://" + ADDR_IP_CAM + ":" + PORT_IP_CAM_RTSP + "/h264";
	}
